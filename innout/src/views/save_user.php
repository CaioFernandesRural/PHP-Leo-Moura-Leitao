    ...
    <form action="#" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="name" name="name" placeholder="informe nome"
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" id="email" name="email" placeholder="informe email"
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="password" id="password" name="password" placeholder="informe senha"
            ...
            <div class="form-group col-md-6">
                ...
                <input type="password" id="confirm_password" name="confirm_password" placeholder="confirme senha"
